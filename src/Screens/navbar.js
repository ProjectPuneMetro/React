        ...
        <div className="container">
          <nav className="navbar navbar-expand-lg navbar-light" style={{ fontFamily: 'Poppins, sans-serif' }}>
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              ...
              <button type="button" className="btn btn-outline-primary" style={{ fontSize: '20px',marginTop:'-40px',marginLeft:'250px'}}onClick={ToSelectTrain}>Book Trains</button>
